...
/**
 * Another "fractalizing" decorator for turtles, this one creating a
 * self-similar pattern of antennas.
 *
...
public class AntennaTurtle extends TurtleDecorator {
     ...
     * @param cutoff The threshold for motion length to fractalize into an
     * antenna.
     */
     ...
     * the turtle with the same position and heading as if the move had been
     * done directly as given.
     *
